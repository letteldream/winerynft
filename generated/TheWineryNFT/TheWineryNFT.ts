...
export class NewMaxElement extends ethereum.Event {
  get params(): NewMaxElement__Params {
    return new NewMaxElement__Params(this);
  }
}

export class NewMaxElement__Params {
  _event: NewMaxElement;

  constructor(event: NewMaxElement) {
    this._event = event;
  }
...
export class NewPriceEvent extends ethereum.Event {
  get params(): NewPriceEvent__Params {
    return new NewPriceEvent__Params(this);
  }
}

export class NewPriceEvent__Params {
  _event: NewPriceEvent;

  constructor(event: NewPriceEvent) {
    this._event = event;
  }
...
export class PauseEvent extends ethereum.Event {
  get params(): PauseEvent__Params {
    return new PauseEvent__Params(this);
  }
}

export class PauseEvent__Params {
  _event: PauseEvent;

  constructor(event: PauseEvent) {
    this._event = event;
  }
...
export class TheWineryNFT__royaltyInfoResult {
  value0: Address;
  value1: BigInt;
...
export class TheWineryNFT extends ethereum.SmartContract {
  static bind(address: Address): TheWineryNFT {
    return new TheWineryNFT("TheWineryNFT", address);
  }
  ...
  START_AT(): BigInt {
    let result = super.call("START_AT", "START_AT():(uint256)", []);

    return result[0].toBigInt();
  }

  try_START_AT(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("START_AT", "START_AT():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  rawOwnerOf(tokenId: BigInt): Address {
    let result = super.call("rawOwnerOf", "rawOwnerOf(uint256):(address)", [
      ethereum.Value.fromUnsignedBigInt(tokenId)
    ]);
  ...
  try_rawOwnerOf(tokenId: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall("rawOwnerOf", "rawOwnerOf(uint256):(address)", [
      ethereum.Value.fromUnsignedBigInt(tokenId)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  royaltyInfo(tokenId: BigInt, value: BigInt): TheWineryNFT__royaltyInfoResult {
    let result = super.call(
      "royaltyInfo",
    ...
    return new TheWineryNFT__royaltyInfoResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_royaltyInfo(
    tokenId: BigInt,
    value: BigInt
  ): ethereum.CallResult<TheWineryNFT__royaltyInfoResult> {
    let result = super.tryCall(
      "royaltyInfo",
      "royaltyInfo(uint256,uint256):(address,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new TheWineryNFT__royaltyInfoResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
...
export class GiftMintCall extends ethereum.Call {
  get inputs(): GiftMintCall__Inputs {
    return new GiftMintCall__Inputs(this);
  }

  get outputs(): GiftMintCall__Outputs {
    return new GiftMintCall__Outputs(this);
  }
}

export class GiftMintCall__Inputs {
  _call: GiftMintCall;

  constructor(call: GiftMintCall) {
    this._call = call;
  }
...
export class GiftMintCall__Outputs {
  _call: GiftMintCall;
...
export class SetMaxElementCall extends ethereum.Call {
  get inputs(): SetMaxElementCall__Inputs {
    return new SetMaxElementCall__Inputs(this);
  }

  get outputs(): SetMaxElementCall__Outputs {
    return new SetMaxElementCall__Outputs(this);
  }
}

export class SetMaxElementCall__Inputs {
  _call: SetMaxElementCall;

  constructor(call: SetMaxElementCall) {
    this._call = call;
  }
...
export class SetMaxElementCall__Outputs {
  _call: SetMaxElementCall;
